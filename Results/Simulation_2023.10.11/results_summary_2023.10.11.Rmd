...
# Non_zero comparison
We can see that as rho increase, the algorithm behave poor in finding the structre. When rho is 0.1, the coefficient is very close to 1. meaning it finds very well the number of non-zero coefficients. And this performance decreases as rho gets bigger.
```{r}
