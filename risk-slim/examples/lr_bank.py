...
coef_l1_df.to_csv('/Users/zhaotongtong/Desktop/Risk_Model_Research/risk-slim/examples/results/lr1_bank_unrounded.csv')

coef_l1_df['Coefs'] = coef_l1_df['Coefs'].astype(float).round(0)
print(coef_l1_df)
coef_l1_df.to_csv('/Users/zhaotongtong/Desktop/Risk_Model_Research/risk-slim/examples/results/lr1_bank.csv')
filter_coef_l1 = coef_l1_df[(coef_l1_df['Coefs'] != 0.0) & (coef_l1_df['Coefs'] !=-0.0) ]
filter_coef_l1.to_csv('/Users/zhaotongtong/Desktop/Risk_Model_Research/risk-slim/examples/results/filter_lr1_bank.csv')
...
coef_l2_df.to_csv('/Users/zhaotongtong/Desktop/Risk_Model_Research/risk-slim/examples/results/lr2_bank_unrounded.csv')

coef_l2_df['Coefs'] = coef_l2_df['Coefs'].astype(float).round(0)
print(coef_l2_df)
coef_l2_df.to_csv('/Users/zhaotongtong/Desktop/Risk_Model_Research/risk-slim/examples/results/lr2_bank.csv')
filter_coef_l2 = coef_l1_df[(coef_l2_df['Coefs'] != 0.0) & (coef_l2_df['Coefs'] !=-0.0) ]
filter_coef_l2.to_csv('/Users/zhaotongtong/Desktop/Risk_Model_Research/risk-slim/examples/results/filter_lr2_bank.csv')