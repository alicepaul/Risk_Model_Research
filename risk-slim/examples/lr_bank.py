...
print(coef_l1_df)
coef_l1_df.to_csv('/Users/zhaotongtong/Desktop/Summer_Research_2022/risk-slim/examples/results/lr1_bank.csv')
filter_coef_l1 = coef_l1_df[(coef_l1_df['Coefs'] != 0.0) & (coef_l1_df['Coefs'] !=-0.0) ]
filter_coef_l1.to_csv('/Users/zhaotongtong/Desktop/Summer_Research_2022/risk-slim/examples/results/filter_lr1_bank.csv')
...
print(coef_l2_df)
coef_l2_df.to_csv('/Users/zhaotongtong/Desktop/Summer_Research_2022/risk-slim/examples/results/lr2_bank.csv')
filter_coef_l2 = coef_l1_df[(coef_l2_df['Coefs'] != 0.0) & (coef_l2_df['Coefs'] !=-0.0) ]
filter_coef_l2.to_csv('/Users/zhaotongtong/Desktop/Summer_Research_2022/risk-slim/examples/results/filter_lr2_bank.csv')