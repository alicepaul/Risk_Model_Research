...
import pandas as pd
# data
data_name = "simulate"                                  # name of the data
...
max_L0_value = 41                                           # maximum model size (set as float(inf))
...
with pd.ExcelWriter('/Users/zhaotongtong/Desktop/Risk_Model_Research/risk-slim/examples/results/result_compare.xlsx',
                    mode='a') as writer:  
    filter_model_result.to_excel(writer, sheet_name='filter_cpa_simulate') 